...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<!-- Edit Barang -->
			<?php foreach($barang as $brg):?>
			<?php echo form_open('Detail/edit') ?>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<select class="form-control" name="produk" id='produk'>
										<option value='0'>--pilih--</option>
										<?php 
											foreach ($produk_edit as $produk) {
												if($brg->id_produk == $produk['id'])
									...
									<div class="form-group row">
										...
										<div class="col-sm-12 col-md-8">
											<select class="form-control" name="warna" id='warna'>
												...
												<?php 
													foreach ($warna as $wr) {
														if($brg->id_warna == $wr['id_warna'])
														echo "<option value='$wr[id_warna]' selected>$wr[nama_warna]</option>";
														else
														echo "<option value='$wr[id_warna]'>$wr[nama_warna]</option>";
													}
												?>
			...
			<!-- Delete Barang -->
			<?php foreach($barang as $brg):?>
			<?php echo form_open('Detail/hapus') ?>
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content bg-warning">
						<div class="modal-body">
							...
							<input class="form-control" type="text" name="produk" id="produk" value="<?php echo $brg->id_produk ?>" hidden>
							<h3 class="mb-15"><i class="fa fa-exclamation-triangle"></i> Warning</h3>
							<p>Apakah Anda Yakin Menghapus Data Barang <?php echo $brg->nama_barang?> Warna <?php echo $brg->nama_warna?>?.</p>
							<div class="row">
								<div class="col-sm-6">
